...
model_uri = 'runs:/c21140d457ad4876807caf1e5329401f/model'
...
import mlflow
logged_model = 'runs:/c21140d457ad4876807caf1e5329401f/model'
...
import pandas as pd
y_pred=loaded_model.predict(infer_data)
print(y_pred[:30])
