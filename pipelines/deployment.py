...
class DeploymentPipeline:
    def __init__(self, model_uri: str = None) -> None:
        ...
        self.model_uri = (
            model_uri if model_uri is not None else project_result["model_uri"]
        )
    ...
    def run_pipeline(self):
        try:
            ...
            logger.info(
                "The best model was deployed as a docker image named handwritten-digit-recognition-model"
            )
        except:
